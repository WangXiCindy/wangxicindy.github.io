...
- **感知机（Perceptron）**
  ...
  - 两层神经元组成
    ...
    <img src="/assets/Pics/MLpics/T66.png" style="zoom:50%;" />
  ...
  - 多层功能神经元
    ...
    - **多层前馈神经网络（multi-layer feedforward neural networks）**
      ...
      - A别称两层网络（本书称为单隐层网络）
        ...
        <img src="/assets/Pics/MLpics/T70.png" style="zoom:50%;" />
...
- 算法思想
  ...
  - 下图有d个输入神经元，l个输出，q个隐藏层神经元
    ...
    <img src="/assets/Pics/MLpics/T71.png" style="zoom:50%;" />
  ...
  - BP算法的工作流程
    ...
    <img src="/assets/Pics/MLpics/T72.png" style="zoom:50%;" />
...
<img src="/assets/Pics/MLpics/T74.png" style="zoom:50%;" />
...
- Boltzmann机（亦称“平衡态（equilibrium）或平稳分布（stationary distribution））
  ...
  - 分类
    ...
    ​		<img src="/assets/Pics/MLpics/T77.png" style="zoom:50%;" />
...
- 本推导来自南瓜书
  ...
  <img src="/assets/Pics/MLpics/T79.png" style="zoom:50%;" />

  <img src="/assets/Pics/MLpics/T80.png" style="zoom:50%;" />

  <img src="/assets/Pics/MLpics/T81.png" style="zoom:50%;" />
...
- 5.7 根据式（5.18）和（5.19），试构造一个能解决疑惑问题的单层RBF神经网络
  ...
  - 结果
    ...
    <img src="/assets/Pics/MLpics/T83.png" style="zoom:50%;" />
...
- 现实任务中，原始样本空间内也许并不存在一个能正确划分两类样本的超平面
  ...
  <img src="/assets/Pics/MLpics/T86.png" style="zoom:50%;" />
...
- 6.7：试给出式（6.52）的完整KKT条件
  ...
  <img src="/assets/Pics/MLpics/T93.png" style="zoom:50%;" />
...
- 通过极大似然法得到的
  ...
  - 根据公式$x^TAx=tr(Axx^T),\bar{x}=\frac{1}{n}\sum _ {i=1}^n x_i$
    ...
    - 引入引理，设B为p阶正定矩阵，n>0 为实数，在对所有p阶正定矩阵有（当且仅当$\sum=\frac{1}{n}B$时等号成立）
      ...
      $\frac{n}{2} \log   \vert \Sigma  \vert +\frac{1}{2} tr[\Sigma^{-1} B] \geq \frac{n}{2} \log   \vert B  \vert +\frac{p n}{2}(1-\log n)$
...
- **独依赖估计（One-Dependent Estimator，简称ODE）**
  ...
  - 如何确定每个属性的父属性
    ...
    - 如图：
      ...
      <img src="/assets/Pics/MLpics/T97.png" style="zoom:50%;" />
    ...
    - **AODE（Averaged One-Dependent Estimator）**
      ...
      -  是类别为c且在第i和j个属性上，取值为$x_i$和$x_j$的样本集合
  
    - 例如，对瓜瓜数据3.0
  
      <img src="/assets/Pics/MLpics/T98.png" style="zoom:50%;" />
...
- **贝叶斯网（Bayesian network）**，别名**信念网（belief network）**
  ...
  - 例如
    ...
    <img src="/assets/Pics/MLpics/T99.png" style="zoom:50%;" />
...
- 结构
  ...
  - 贝叶斯网三种变量之间典型依赖关系
    ...
    <img src="/assets/Pics/MLpics/T100.png" style="zoom:50%;" />
    ...
    - **V型结构（V-structure）**，别名**冲撞**结构：给定子结点$x_4$的取值，$x_1,x_2$必不独立
      ...
      - 记为<img src="/assets/Pics/MLpics/T101.png" style="zoom:50%;" />
  ...
  - 假定道德图中有变量x，y和变量集合z
    ...
    - x和y被z有向分离：从道德图中将变量集合z去除后，x和y分属两个连通分支，$x \perp y \mid z$   成立
      ...
      <img src="/assets/Pics/MLpics/T102.png" style="zoom:50%;" />
...
- 推断
  ...
  - 吉布斯采样是在贝叶斯网所有变量的联合状态空间与证据$E=e$一致的子空间中进行**随机漫步（random walk）**
    ...
    <img src="/assets/Pics/MLpics/T103.png" style="zoom:50%;" />
...
- 7.1 试使用极大似然法估算西瓜数据集3.0中前3个属性的类条件概率
  ...
  <img src="/assets/Pics/MLpics/T54.png" style="zoom:50%;" />
