    ...
    - AUC：如果两个ROC曲线发生交叉，则难以一般性断言两者谁优谁劣，此时比较ROC曲线的面积=AUC
      ...
      - 🎃书案例：
        ...
        **梯形面积**$=\frac{1}{2} \left(x _ {i+1}-x _ {i}\right) \cdot\left(y _ {i}+y _ {i+1}\right)$
        ...
        <img src="/assets/Pics/MLpics/T4.png" style="zoom:50%;" />
    ...
    - **t检验**（大学概率学习内容）
      ...
      - 大学概率补充知识：
        ...
        - 得到服从自由度为k-1的t分布
          ...
          <img src="/assets/Pics/MLpics/T9.png" style="zoom:50%;" />
...
- **Friedman检验**与Nemenyi后续检验
  ...
  - 现在通常使用**F检验**
      ...
      - 补充知识，**F分布**
        ...
        <img src="/assets/Pics/MLpics/T17.png" style="zoom:50%;" />
        ...
        - 补充：
          ...
          - 满秩矩阵：设A是n阶矩阵, 若r（A） = n, 则称A为满秩矩阵。但满秩不局限于n阶矩阵。
            ...
            - 如下图
              ...
              <img src="/assets/Pics/MLpics/T24.png" style="zoom:50%;" />
...
- **广义线性模型**
  ...
  - 对数线性回归
    ...
    - 譬如我们认为示例所对应的输出标记是在指数尺度上变化
      ...
      - <img src="/assets/Pics/MLpics/T25.png" style="zoom:50%;" />
...
- $y=\frac{1}{1+e^{-(w^Tx+b)}}$  公式推导
  ...
  - 若预测值z大于0就判为正例，小于0则判为反例，预测值为临界值0则可以任意判别
    ...
    <img src="/assets/Pics/MLpics/T26.png" style="zoom:50%;" />
...
- 3.2 试证明，对于参数w，对率回归的目标函数（3.18）是非凸的，但其对数似然函数（3.27）是凸的
  ...
  - 凸函数就是一个定义在某个向量空间的凸子集C（区间）上的实值函数
    ...
    ![](/assets/Pics/MLpics/T33.png)

    - 定义

      <img src="/assets/Pics/MLpics/T34.png" style="zoom:70%;" />
      ...
      - **Hessian（海森）矩阵**
        ...
        ![](/assets/Pics/MLpics/T35.png)

      - 半正定：对任意不为0的是实列向量X，都有$X^TAX>=0$

      - 泰勒展开

        <img src="/assets/Pics/MLpics/T36.png" style="zoom:80%;" />

        ![](/assets/Pics/MLpics/T37.png)
...
- 3.3 编程实现对率回归，并给出西瓜数据集$3.0\alpha$的结果
  ...
  <img src="/assets/Pics/MLpics/T38.png" style="zoom:50%;" />
...
- 3.5
  ...
  <img src="/assets/Pics/MLpics/T42.png" style="zoom:50%;" />
...
- 基于树结构进行决策
  ...
  <img src="/assets/Pics/MLpics/T43.png" style="zoom:50%;" />
...
- 流程：**分而治之（divide-and-cunquer）**
  ...
  ​	<img src="/assets/Pics/MLpics/T44.png" style="zoom:40%;" />
...
- **信息增益**
  ...
  - 信息增益
    ...
    - 案例：
      ...
      <img src="/assets/Pics/MLpics/T45.png" style="zoom:50%;" />
      ...
      - 计算出当前属性集合中每个属性的信息增益
        ...
        - 当前的信息增益
          ...
          <img src="/assets/Pics/MLpics/T46.png" style="zoom:50%;" />

        - 属性“纹理”的信息增益最大，被选为划分属性

          <img src="/assets/Pics/MLpics/T47.png" style="zoom:50%;" />

        - 然后分别计算这三个类别的剩下六个属性的信息增益做进一步划分

          <img src="/assets/Pics/MLpics/T48.png" style="zoom:50%;" />

          <img src="/assets/Pics/MLpics/T49.png" style="zoom:50%;" />
  ...
  - **CART**决策树
    ...
    - 案例
      ...
      - 色泽取值：{青绿，乌黑，浅白}
        ...
        <img src="/assets/Pics/MLpics/T50.png" style="zoom:50%;" />
...
- 剪枝策略
  ...
  - **预剪枝（prepruning）**
    ...
    - 案例：根据信息增益准则
      ...
      - 选择“脐部”来进行划分，产生三个分支
        ...
        <img src="/assets/Pics/MLpics/T51.png" style="zoom:50%;" />
  ...
  - **后剪枝（post-pruning）**
    ...
    - 先从训练集生成一棵完整决策树，如上图4.5
      ...
      <img src="/assets/Pics/MLpics/T52.png" style="zoom:50%;" />
    ...
    - 结果
      ...
      <img src="/assets/Pics/MLpics/T53.png" style="zoom:50%;" />
    ...
    - 案例：
      ...
      - 在西瓜数据集2.0加上连续属性“密度”和“含糖率”，得到西瓜数据3.0
        ...
        - 含糖率
          ...
          <img src="/assets/Pics/MLpics/T55.png" style="zoom:50%;" />
...
- 缺失值处理
  ...
  - 如果直接放弃不完整样本
    ...
    <img src="/assets/Pics/MLpics/T56.png" style="zoom:50%;" />
  ...
  - 案例：（以表4.4为例）
    ...
    - <img src="/assets/Pics/MLpics/T57.png" style="zoom:50%;" />
    ...
    - 纹理信息增益最大，被用于对根结点进行划分
      ...
      - 结果：
        ...
        <img src="/assets/Pics/MLpics/T58.png" style="zoom:50%;" />
...
- **轴平行（axis-parallel）**
  ...
  - 生成的决策树和分类边界
    ...
    <img src="/assets/Pics/MLpics/T59.png" style="zoom:50%;" />
  ...
  - 分类边界的每一段都与坐标轴平行，这样的分类边界使学习结构有较好的可解释性
    ...
    - 如下图，决策树更加复杂，需要更多的属性测试，预测时间开销变大
      ...
      <img src="/assets/Pics/MLpics/T60.png" style="zoom:50%;" />
...
- **多变量决策树（multivariate decision tree）**
  ...
  - 与传统的“单变量决策树（univariate decision tree）”不同，在多变量决策树的学习过程中
    ...
    - 针对西瓜数据3.0
      ...
      <img src="/assets/Pics/MLpics/T61.png" style="zoom:50%;" />
...
- 4.3 试变成实现基于信息熵进行划分选择的决策树算法，并为表4.3中数据生成一棵决策树
  ...
  ​	<img src="/assets/Pics/MLpics/T62.png" style="zoom:50%;" />
...
- 4.4 试实现基于基尼指数进行划分选择的决策树算法，为表4.2中数据生成预剪枝、后剪枝决策树，并与未剪枝决策树进行比较
  ...
  - 结果
    ...
    <img src="/assets/Pics/MLpics/T63.png" style="zoom:70%;" />
